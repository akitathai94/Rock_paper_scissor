...
private:
    ...
    void init_sizer();
    void on_game_end();
    void reset_the_display();
    void set_game_start_display();
    OPTIONS wxString_to_OPTIONS(wxString human_choice_wxString);
    string OPTIONS_to_wxString(OPTIONS option);
    string GAMEResult_to_wxString(GAME_RESULT result);
    // Panels
