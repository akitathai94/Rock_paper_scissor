...
class Game {
    ...
    GAME_RESULT getCurrentRoundWinner( );    // To get round winner based on an input choice
    ...
    OPTIONS getCurrentRoundPlayerChoice();        // the choice that computer made in the current round
    void startRound();                              // get choices for computer and human
private:
    /*
